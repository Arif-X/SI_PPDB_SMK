						...
						<div class="row">
							...
							<div class="col-lg-6">
								<ol class="breadcrumb pull-right">
									...
									<li class="breadcrumb-item active">PASFOTO</li>
								</ol>
							</div>
						</div>
					</div>
								...
								<div class="modal-dialog modal-dialog-centered" role="document">
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title" id="modalLabel">Tambah/Ganti Pasfoto</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												<span aria-hidden="true">&times;</span>
											</button>
										</div>
										<div class="modal-body">
											<form method="POST" action="../../../backend/peserta/pasfoto/create-or-update.php" enctype="multipart/form-data">
						...
						<div class="col-md-12">
							<div class="card">
								...
								while($foto = $getData->fetch_array()) {						
									echo '<div><img src="' . $foto['pasphoto'] . '" class="img-fluid" style="max-width: 50%;"></div><br>';
									echo '<div><a href="../../../backend/peserta/pasfoto/download.php?uid='. $foto['uid'] .'" type="button" class="btn btn-primary">Download</a></div>';
								}
								?>
							</div>
						</div>
